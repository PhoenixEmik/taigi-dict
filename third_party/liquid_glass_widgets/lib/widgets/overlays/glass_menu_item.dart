...
class _GlassMenuItemState extends State<GlassMenuItem> {
  ...
  Widget build(BuildContext context) {
    ...
    final Color textColor = widget.isDestructive
        ...
        : isLight
            ? const Color(0xDD000000) // Colors.black.withValues(alpha: 0.87)
            : const Color(
                0xE6FFFFFF,
              ); // Colors.white.withValues(alpha: 0.9) cached
    ...
    final Color iconColor = widget.isDestructive
        ...
        : isLight
            ...
            : const Color(
                0xB3FFFFFF,
              ); // Colors.white.withValues(alpha: 0.7) cached

    // Dynamic background for hover/press states
    // Use adaptive overlays so light-mode menus do not wash out.
